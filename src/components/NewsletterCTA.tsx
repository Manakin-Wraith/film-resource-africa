      ...
      <form onSubmit={handleSubscribe} className="flex flex-col gap-2.5 w-full">
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full bg-white/5 border border-white/10 rounded-2xl pl-11 pr-4 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all text-foreground placeholder:text-foreground/50"
          />
        </div>
        <button
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
          ...
          <form onSubmit={handleSubscribe} className="flex gap-2.5 w-full md:w-auto flex-shrink-0">
            <input
              ...
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              className="flex-grow md:w-56 border border-white/[0.12] rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-primary/50 transition-colors text-foreground placeholder:text-foreground/50"
