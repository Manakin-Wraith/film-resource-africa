...
// into a bilateral Producer <-> FRA form. Clauses 1-12 kept substantively verbatim.
...
1. Background and Purpose. The Parties wish to explore and evaluate a possible collaboration in relation to the financing, structuring and production of one or more film and television projects, including the assembly of a production slate (the "Purpose"). For this Purpose the Parties will exchange commercially sensitive information, including production budgets and actuals, financing structures, cashflow schedules, recoupment and waterfall terms, risk analyses, investor and counterparty terms, slate plans and related materials. This Agreement governs the disclosure and protection of that information.
