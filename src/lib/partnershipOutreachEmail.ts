/**
 * FRA Partnership Outreach Email Template
 *
 * Usage:
 *   buildPartnershipOutreachHtml({
 *     siteUrl: 'https://www.film-resource-africa.com',
 *     recipientName: 'Omorinsojo',
 *     recipientOrg: 'NIF Summit',
 *     senderName: 'Gerhard Mostert',
 *     senderPosition: 'Founder',
 *   })
 */
...
export function buildPartnershipOutreachHtml({
  siteUrl,
  recipientName,
  recipientOrg,
  senderName,
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
          ...
          <tr>
            <td style="padding-bottom:32px;font-size:15px;line-height:1.7;color:#b0b0b0;">
              ...
              <a href="${cleanUrl}" style="color:#3b82f6;text-decoration:none;font-size:14px;">${displayUrl}</a>${senderLinkedin ? `<br/>
